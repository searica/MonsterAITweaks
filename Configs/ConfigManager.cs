...
namespace MonsterAITweaks.Configs {
    internal static class ConfigManager {
        ...
        internal static void Init(string GUID, ConfigFile config, bool saveOnConfigSet = false) {
            ...
            ConfigFileFullPath = Path.Combine(BepInEx.Paths.ConfigPath, ConfigFileName);
        }
        ...
        internal static void SetupWatcher() {
            var watcher = new FileSystemWatcher(BepInEx.Paths.ConfigPath, ConfigFileName);
